...
if __name__ == "__main__":
    ...
    while True:
        ...
        if ids is not None:
            ...
            ctrl_sig = pid.p_ctrl(quad_coord_x)
            ctrl_sig = ut.bound(ctrl_sig, 0, 0.3)
            ...
            if quad_coord_x > safe_zone_sz_x:
                ...
                turn_direction = 'STOP'
                robot.stop()
            # print(w_rz, h_rz, ' - ', center_x, ' | ', quad_coord_x, ' | ', turn_direction, end=' | ')
